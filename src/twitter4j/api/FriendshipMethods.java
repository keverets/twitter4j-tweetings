...
public interface FriendshipMethods {
     ...
     * @since Twitter4J 2.1.9
     */
    Relationship updateFriendship(String screenName, boolean retweets) throws TwitterException;
     ...
     * @since Twitter4J 2.1.9
     */
    Relationship updateFriendship(long userId, boolean retweets) throws TwitterException;
