...
public interface AccountMethods {
    ...
    /**
     * Updates the authenticating user's profile image.
     * <br>This method calls http://api.twitter.com/1.1/account/update_profile_banner.json
     *
     * @param image Must be a valid GIF, JPG, or PNG image of less than 5 megabytes in size.
     * @return the updated user
     * @throws TwitterException when Twitter service or network is unavailable,
     *                          or when the specified file is not found (FileNotFoundException will be nested),
     *                          or when the specified file object in not representing a file (IOException will be nested)
     ...
     * @since Twitter4J 2.1.11
     */
    User updateBannerImage(File image) throws TwitterException;
     ...
     * @since Twitter4J 2.1.11
     */
    User updateBannerImage(InputStream image) throws TwitterException;
