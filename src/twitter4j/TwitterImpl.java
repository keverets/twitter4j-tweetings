...
class TwitterImpl extends TwitterBaseImpl implements Twitter {
    ...
    TwitterImpl(Configuration conf, Authorization auth) {
        super(conf, auth);
        INCLUDE_ENTITIES = new HttpParameter("include_entities", true);
    ...
    public ResponseList<Status> getUserMediaTimeline(String screenName, Paging paging)
            throws TwitterException {
        return factory.createStatusList(get("https://api.twitter.com/1/"
     ...
     */
    @Override
    public ResponseList<Status> getUserMediaTimeline(long userId, Paging paging)
            throws TwitterException {
        return factory.createStatusList(get("https://api.twitter.com/1/"
                + "statuses/media_timeline.json",
                mergeParameters(new HttpParameter[]{new HttpParameter("user_id", userId)
     ...
     */
    @Override
    public ResponseList<Status> getUserMediaTimeline(String screenName) throws TwitterException {
        return getUserMediaTimeline(screenName, new Paging());
    }
     ...
     */
    @Override
    public ResponseList<Status> getUserMediaTimeline(long userId) throws TwitterException {
        return getUserMediaTimeline(userId, new Paging());
    }
     ...
     */
    @Override
    public ResponseList<Status> getUserMediaTimeline() throws
            TwitterException {
        return getUserMediaTimeline(new Paging());
    }
     ...
     */
    @Override
    public ResponseList<Status> getUserMediaTimeline(Paging paging) throws
            TwitterException {
        ensureAuthorizationEnabled();
        return factory.createStatusList(get("https://api.twitter.com/1/" +
                "statuses/media_timeline.json",
    ...
    public PagableResponseList<UserList> getUserLists(String listOwnerScreenName, long cursor) throws TwitterException {
        return factory.createPagableUserListList(get(conf.getRestBaseURL() + "lists/list.json?screen_name=" + listOwnerScreenName + "&cursor=" + cursor));
    }
    ...
    public PagableResponseList<UserList> getUserLists(long listOwnerUserId, long cursor) throws TwitterException {
        return factory.createPagableUserListList(get(conf.getRestBaseURL() + "lists/list.json?user_id=" + listOwnerUserId + "&cursor=" + cursor));
    }
     ...
     */
    @Override
    public Relationship updateFriendship(String screenName, boolean retweets) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createRelationship(post(conf.getRestBaseURL() + "friendships/update.json",
                new HttpParameter[]{
                        new HttpParameter("screen_name", screenName),
     ...
     */
    @Override
    public Relationship updateFriendship(long userId, boolean retweets) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createRelationship((post(conf.getRestBaseURL() + "friendships/update.json",
                new HttpParameter[]{
                        new HttpParameter("user_id", userId),
    ...
    public RateLimitStatus getRateLimitStatus() throws TwitterException {
        return factory.createRateLimitStatus(get(conf.getRestBaseURL() + "application/rate_limit_status.json"));
    }
     ...
     */
    @Override
    public User updateBannerImage(File image)
            throws TwitterException {
        ensureAuthorizationEnabled();
        checkFileValidity(image);
        return factory.createUser(post(conf.getRestBaseURL() + "account/update_profile_banner.json",
     ...
     */
    @Override
    public User updateBannerImage(InputStream image) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createUser(post(conf.getRestBaseURL()
    ...
    public ResponseList<User> getBlockingUsers() throws
            TwitterException {
        ensureAuthorizationEnabled();
        return factory.createUserList(get(conf.getRestBaseURL() + "blocks/list.json"));
    }
    ...
    public ResponseList<User> getBlockingUsers(int page) throws
            TwitterException {
        ensureAuthorizationEnabled();
        return factory.createUserList(get(conf.getRestBaseURL() + "blocks/list.json?page=" + page));
    }
