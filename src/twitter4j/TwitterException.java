...
public class TwitterException extends Exception implements TwitterResponse, HttpResponseCode {
    ...
    public boolean exceededRateLimitation() {
        return ((statusCode == 400 || statusCode == 429) && getRateLimitStatus() != null) // REST API
    ...
    private static String getCause(int statusCode) {
        ...
        switch (statusCode) {
            ...
            case BAD_REQUEST:
                ...
                break;
            case RATE_LIMITED:
                cause = "This is the status code that will be returned during rate limiting (https://dev.twitter.com/pages/rate-limiting).";
                break;
            case UNAUTHORIZED:
