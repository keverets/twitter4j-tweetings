...
public interface TimelineMethods {
     ...
     * @since Twitter4J 2.1.0
     */
    ResponseList<Status> getUserMediaTimeline(long userId, Paging paging) throws TwitterException;
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1/get/statuses/user_timeline">GET statuses/user_timeline | Twitter Developers</a>
     */
    ResponseList<Status> getUserMediaTimeline(String screenName) throws TwitterException;
     ...
     * @since Twitter4J 2.1.0
     */
    ResponseList<Status> getUserMediaTimeline(long userId) throws TwitterException;
